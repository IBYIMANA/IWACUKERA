    ...
    <div>
      ...
      <div className='px-4 py-20 md:py-40 sm:p-7'>
        <motion.h1
          ...
          className='mb-16  mt-6 text-4xl font-extrabold text-center text-red-900'
        >
          Imikino gakondo yo mu Rwanda
        </motion.h1>
        <div className='bg-red-50 rounded-lg shadow-lg justify-between px-4 md:px-32 '>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            <motion.img
              ...
              transition={{ duration: 1, delay: 0.5 }}
              className='w-full md:w-1/2 rounded-lg h-80 shadow-lg px-6 pt-6 pb-6'
            />
            <div>
              <motion.h1
                initial={{ opacity: 0, x: 100 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 1, delay: 0.5 }}
                className='mt-4 md:mt-10 mb-4 md:mb-10 text-3xl font-bold'
              >
                URUKIRAMENDE
              </motion.h1>
              <motion.p
        ...
        <div className='bg-red-50 rounded-lg shadow-lg px-4 md:px-32 mt-7 justify-between'>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            <motion.img
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 1, delay: 0.5 }}
              className='w-full md:w-1/2 rounded-lg shadow-lg px-6 pt-6 pb-6'
            />
            <div>
              <motion.h1
                initial={{ opacity: 0, x: 100 }}
        ...
        <div className='bg-red-50 rounded-lg shadow-lg px-4 md:px-32  mt-7'>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            <motion.img
              src="../public/ibyino.jpeg"
              alt=""
              className='w-full md:w-1/2 h-auto rounded-lg shadow-lg px-6 pt-6 pb-6'
            />
            <div>
              <h1 className='mt-4 md:mt-10 mb-4 md:mb-10 text-3xl font-bold'>IMBYINO</h1>
              <p>
        ...
        <div className='bg-red-50 rounded-lg shadow-lg px-4 md:px-32  mt-7'>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            ...
            />
            <div>
              <h1 className='mt-4 md:mt-10 mb-4 md:mb-10 text-3xl font-bold'>GUHIGA</h1>
              <p>
        ...
        <div className='bg-red-50 rounded-lg shadow-lg px-4 md:px-32  mt-7'>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            ...
            />
            <div>
              <h1 className='mt-4 md:mt-10 mb-4 md:mb-10 text-3xl font-bold'>IGISORO</h1>
              <p>
        ...
        <div className='bg-red-50 rounded-lg shadow-lg px-4 md:px-32  mt-7'>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            ...
            />
            <div>
              <h1 className='mt-4 md:mt-10 mb-4 md:mb-10 text-3xl font-bold'>UMUDURI</h1>
              <p>
        ...
        <div className='bg-red-50 rounded-lg shadow-lg px-4 md:px-32  mt-7'>
          <div className='flex flex-col md:flex-row gap-8 bg-gray-50 rounded-lg shadow-lg '>
            ...
            />
            <div>
              <h1 className='mt-4 md:mt-10 mb-4 md:mb-10 text-3xl font-bold'>GUSIMBUKA UMUGOZI</h1>
              <p>
