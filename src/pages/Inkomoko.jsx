...
function Inkomoko() {
  return (
    <div>
        <div className='bg-gray-200 mt-[7%] px-4 py-7 sm:px-6 md:px-10 lg:px-20 xl:px-40'>
          <h1 className='text-center text-2xl sm:text-3xl md:text-4xl mb-4 font-extrabold capitalize'>
          ...
          <h1 className='text-xl sm:text-2xl font-semibold mb-2'>Ku ikubitiro Abahigi n’abatoraguzi</h1>
          <p className='mb-4'>
          ...
          <h1 className='text-center text-xl sm:text-2xl md:text-3xl font-medium mt-4 mb-4'>Ubworozi bwabanjirije ubuhinzi</h1>
          <p className='mb-4'>
