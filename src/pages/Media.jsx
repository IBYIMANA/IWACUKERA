        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
          {mediaList.map(media => (
            <div key={media._id} className="p-6 bg-white rounded-lg shadow-sm hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-700">Kanda hano ukurikirane ikiganiro: <a href={media.link} className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">{media.link}</a></p>
