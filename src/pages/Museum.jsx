  ...
  return (
    <div>
        ...
        <div className='px-4 py-40 '>
          ...
          <h1 className='mb-5 text-4xl font-bold text-center mt-20'>Ibikoresho by'umuco</h1>
          <div className='grid justify-around grid-cols-1 gap-10 px-4 lg:grid-cols-4 md:grid-cols-2'>
            <div className='justify-center bg-white rounded-lg shadow-lg hover:scale-105 px-5 py-5'> 
            <img src="../public/uruswo.jpg" className="transition duration-300 transform bg-white rounded-md hover:scale-105"/>
            <p className='text-2xl font-bold text-center mt-4 mb-4'>URUSYO</p>
            <p className='text-center'>Urusyo rusobanura ibuye, rimeze nk'uruziga useraho (rwo gusya ingano), uruziga rukomey . Mu kwagura ikintu cyizengurutse cyane ibyatsi cyangwa uruziga rwa foromaje . Iri jambo rishobora kandi kwerekeza ikirundo cy'ibiti bitwikiriwe nisi ikoreshwa mu gukora amakara .</p>
            </div>
            <div className='justify-center bg-white rounded-lg shadow-lg hover:scale-105 px-5 py-5'> 
            <img src="../public/ingobyi.jpg" className="transition duration-300 transform bg-white rounded-md hover:scale-105"/>
            <p className='text-2xl font-bold text-center mt-4 mb-4'>INGOBYI</p>
            <p className='text-center'>Ingobyi ya Kinyarwanda ni igikoresho gifite ibigwi n’amateka ahambaye mu muco wu Rwanda, kikaba ari kimwe mu bigaragaza intekerezo z’ihangabuhanga abantu b'Abanyarwanda bari bakungahayeho aho yabafashaga guhanga ibikoresho bibafasha gukemura ibibazo biriho muri icyo gihe hari mo ingobyi yo guheka abarwayi.</p>
            </div>
            <div className='justify-center bg-white rounded-lg shadow-lg hover:scale-105 px-5 py-5'> 
            <img src="../public/inkongoro.jpg" className="transition duration-300 transform bg-white rounded-md hover:scale-105"/>
            <p className='text-2xl font-bold text-center mt-4 mb-4'>IGISABO</p>
            <p className='text-center'> Igisabo ni igikoresho cyubashywe mu muco nyarwanda kuva kera, cyifashishwa mu gikorwa cyo ‘gucunda amata’, amata nayo akaba ari ikinyobwa gifite intungamubiri nyinshi ku mubiri w’umuntu.</p>
            <p className='text-center'>inkongoro nigikoresho kera  banyweramo amata</p>
            </div>
            <div className='justify-center bg-white rounded-lg shadow-lg hover:scale-105 px-5 py-5'> 
            <img src="../public/igicuma.webp" />
            <p className='text-2xl font-bold text-center mt-4 mb-4'>UDUCUMA</p>
            <p className='text-center'> mumuco nyarwanda iyo umuntu yagusuraga wamyakirizaga icyokunywa nkinzoga ,amata ibi nibikoresho bakoreshaga banyweramo inzoga ,banazibikamo ibyo bita kuzitara kugirango zishye </p>
            </div>
