...
const ResponsiveContent = () => {
  return (
    <div>
      <div className='flex flex-col gap-8 px-6 pb-6 mb-4 rounded-lg shadow-md lg:flex-row bg-slate-100 sm:px-9'>
        <div className='w-full lg:w-1/2 h-64 sm:h-80 md:h-[35rem] mt-12'>
          <motion.img
            src="/abakuze.jpg"
            alt=""
        ...
        <div className='w-full mt-12 lg:w-1/2 lg:mt-28'>
          ...
          <a href="https://www.igihe.com/umuco/amateka/article/byagenze-gute-ngo-abantu-bature-mu-rwanda">
            <button className='w-full h-10 mt-6 mb-4 text-white bg-green-600 rounded-lg shadow-xl sm:w-32 hover:bg-white hover:text-black'>
              Komeza Usome
            </button>
          </a>
        </div>
        <div className='flex flex-col items-center w-full gap-4 mt-12 rounded-lg shadow-lg lg:w-1/4 lg:mt-28'>
          <div className='w-40 h-40'>
            <img src="inka.jpg" alt="" className='object-cover w-full h-full rounded-lg' />
          </div>
          <div className='w-40 h-40'>
            <img src="inyambo.jpg" alt="" className='object-cover w-full h-full rounded-lg' />
          </div>
        </div>
      </div>

      <div className='flex flex-col justify-center px-6 pb-6 mb-4 rounded-lg shadow-md lg:flex-row bg-slate-50 sm:px-9 gap-7'>
        <img src="/connect.jpg" alt="" className='object-cover w-full h-64 rounded-lg lg:w-1/2 sm:h-80 md:h-96' />
        <div className='w-full lg:w-1/2'>
          ...
          <p className='mt-4 text-base text-center sm:text-lg md:text-xl'>
