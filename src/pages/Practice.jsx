...
const Practice = () => {
  return (
    <div>
      <div className='flex  bg-slate-100 shadow-md round-lg gap-8 px-9 pb-6 mb-4   '>
        <div className=' w-[250rem] h-[35rem] mt-[7rem]'>
          <motion.img src="/abakuze.jpg" alt=""
            initial={{ opacity: 0, x: -100 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1, delay: 0.5 }}
            className=' w-["100%"] h-[100%]' resizeMode='cover' />
        </div>

        <div className='w-[400rem]  mt-28'>
          <h1 className='font-medium text-4xl '>Uko u Rwanda rwatuwe kuva mu myaka ibihumbi ishize</h1>
          < motion.p   initial={{opacity:0,y:-100}}
                      animate={{opacity:1,y:0}}
                      transition={{duration:1 , delay:0.5}}className='mt-4'>U Rwanda, igihugu bamwe bivugira, batazi inkomoko y’iryo zina, ruteye amatsiko kumenya igihe rwaturiwe, bamwe bemeza ko ari ejobundi mu mwaka wa 1091 nyuma y’ivuka rya Yezu, abandi bakemeza ko rwamutanze kuvuka.</motion.p>
          <motion.p  initial={{opacity:0,y:-100}}
                      animate={{opacity:1,y:0}}
                      transition={{duration:1 , delay:0.5}} >U Rwanda, amateka yagiye yandikwa, avuga ko rwatangiye ari agahugu gato, kari i Gasabo mu Karere ka Gasabo kuri ubu, muri ako karere ubu niho habarizwa ibiro bitandukanye by’ubuyobozi bw’igihugu, iby’Umukuru w’Igihugu, Minisiteri nyinshi n’ibindi bigo bikomeye mu Rwanda, ariko aho rwatangiriye, uhabwirwa n’ikigabiro gihari,nta kundi kuhabona hitabwaho kugeza ubu.
            ...
            Guhera icyo gihe, ubwami bw’u Rwanda bwatangiye gusugira mu karere, aho rwageraga mu mbibi za Repubulika Iharanira Demukarasi ya Kongo y’ubu, rugakomeza mu Bugande hafi y’ikiyaga cya Edward.</motion.p>
          <h1 className='font-medium  text-slate-400'>Inkomoko y’abatuye u Rwanda</h1>
          <a href="https://www.igihe.com/umuco/amateka/article/byagenze-gute-ngo-abantu-bature-mu-rwanda">
            <button className='w-32 h-10 text-white bg-green-600 rounded-lg shadow-xl hover:bg-white hover:text-black mt-6 mb-4 ml-20 animate-bounce'>Komeza Usome</button>
          </a>
        </div>
        <div className='w-full shadow-lg rounded-lg justify-center mt-28 gap-4 flex flex-col '>
          <div className=' h-52 w-52 top-0  '>

            <img src="inka.jpg" alt="" className=' h-[100%] w-[100%]' />
          </div>
          <div className=' h-52 w-52'>

            <img src="inyambo.jpg" alt="" className=' h-[100%] w-[100%]' />
          </div>

        </div>
      </div>
      <div className='flex bg-slate-50 shadow-md round-lg justify-center px-9 pb-6 mb-4 gap-7'>
        <img src="/connect.jpg" alt="" />

        <div>
          <h1 className='font-bold  mb-4 mt-7  text-4xl text-center '>ITUMANAHO RYO HAMBERE</h1>
      ...
      <div className='flex bg-slate-50 shadow-md round-lg justify-center px-9 pb-6 mb-4 gap-7'>
        <div>
          <h1 className='font-bold  mb-4 mt-7  text-4xl text-center '>UKO BAKORAGA INGENDO</h1>
          <p className='text-center'>
            U Rwanda ryohambere Indege n'imodoka bitaraza ingendo zakorwaga hifashishijwe igikoresho bita INGOBYI.
          </p>
          <p className='text-center'>Ingobyi yishwashishwaga mugutwara Abami igehe babaga bakeneye gutembere igihugu cyabo,
            ndetse ikaba yaranifashishwaga mugutwara Umugeni igihe agiye kurongorwa ndetse kandi yanifashishwaga mukujyana abarwayi kwa muganga</p>

        </div>
        <div className='  w-[100rem] h-96 px-19 '>
          <img src="/ingo.png" alt="" className='h-[100%] w-[100%]' />
        </div>
