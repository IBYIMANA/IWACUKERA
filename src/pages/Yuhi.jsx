  ...
  return (
    <div>
      <div className='bg-gray-200 mt-[7%] px-40 py-7'>
        <h1 className='text-center text-4xl mb-4 font-extrabold capitalize'> Amateka y'umwami Yuhi V Musinga hamwe n'abandi Bami </h1>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4'> Ndahiro Ruyange (1180-1213)</h1>
<p>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4'> Ndoba (1213-1246)</h1>
