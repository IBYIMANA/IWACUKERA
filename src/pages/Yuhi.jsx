  ...
  return (
    <div>
      <div className='bg-gray-200 mt-[7%] px-40 py-7 sm:px-6 md:px-10 lg:px-20 xl:px-40'>
        <h1 className='text-center text-4xl mb-4 font-extrabold capitalize  sm:text-3xl md:text-4xl'> Amateka y'umwami Yuhi V Musinga hamwe n'abandi Bami </h1>
        <p>Umwami wakirikiye Kanyarwanda ku itonde ry'abami b'umushumi yitwa Yuhi Musindi akaba yaranitwaga "Yuhi ry'i Gara".
...
Uyu mwami ni we mukurambere w'ubwoko bw'Abasindi ari na ho ubu bwoko bukomora iryo zina nk'uko benshi mu buzukuru ba Gihanga bagiye batanga amazina y'ubwoko bubakomokaho..</p>
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'> Ndahiro Ruyange (1180-1213)</h1>
<p>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'> Ndoba (1213-1246)</h1>
<p>Umwami wa gatanu ku itonde ry'abami b'umushumi ni uyu twari dukomojeho witwa Ndoba, izina mu Kinyarwanda gisanzwe ngo ryaba rituruka ku nshinga "Kuroba".
...
Cyambwe ukomokwaho n'Abenecyambwe n'abandi.</p>
<p>Ayo yose akaba ari amoko y'inzu afite inkomoko ku muryango mugari w'Abanyiginya.

Imyinshi muri iyi miryango igenda igaragara mu mihango y'ubwiru itandukanye nk'uw'Abakobwa bakomokamo uwitwa Cyenge wigeze gutegeka mu nzibacyuho ubwo Ruganzu bwimba yatangaga ndetse kuva ubwo uyu muryango ukagabirwa kuyobora intebe y'Abiru.</p>

<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'>Umwami Mibambwe I Sekarongoro I Mutabazi I</h1>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'>Umwami Yuhi II Gahima</h1>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'>Umwami Ruganzu II Ndoli</h1>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'>Umwami Cyilima II Rujugira</h1>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'>Umwami Kigeli III Ndabarasa</h1>
...
<h1 className='text-center text-2xl mb-4 font-medium mt-4  sm:text-3xl md:text-4xl'>Umwami Yuhi IV Gahindiro</h1>
